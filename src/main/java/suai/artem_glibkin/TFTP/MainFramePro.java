...
public class MainFramePro extends javax.swing.JFrame {

    public MainFramePro() {
        this.setTitle("TFTP Клиент PRO версия");
        ...
        fileChooser.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(MainFramePro.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
